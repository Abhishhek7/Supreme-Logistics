        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-8">
              At <span className="font-semibold">GlobalTrack Logistics</span>, we specialize in reliable and efficient delivery solutions. From same-day deliveries to managing supply chains, we ensure smooth, fast, and secure logistics across the country.
            </p>
            <div>
              <a
                href="#!"
